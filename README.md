...
# Hey, I'm Chris
### Cloud Systems Administrator | AWS · Terraform · Automation
...
![Profile Views](https://komarev.com/ghpvc/?username=cmeader1053)
</div>
...
Cloud Systems Administrator with hands-on experience across AWS infrastructure, Fortinet and Cisco networking, and hybrid environment monitoring with Zabbix. I lean toward automating repetitive work wherever possible whether that's infrastructure-as-code with Terraform, scripting in PowerShell, Python, or Bash, or building tooling that cuts down on manual toil. I enjoy taking on challenges and creating solutions in the realm of cloud, networks and systems. 

Currently open to Cloud/Systems Engineer and DevOps roles in the Cleveland, OH area — remote or hybrid preferred.
